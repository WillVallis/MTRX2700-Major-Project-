...
/************************************************************
Returns the current edge values
************************************************************/
...
/************************************************************
Swtiches the pan direction and updates the currently stored 
edge values.
************************************************************/
...
void switch_dir (void) {
  ...
  GetLatestLaserSample(&sample);
  dist = lidar_to_dist(sample);
  angl = crnt_angle();
  crnt_dir = toggle; 
